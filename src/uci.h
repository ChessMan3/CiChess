...
#define OPT_FAST_PLAY           5
#define OPT_HIDE_INFO           6
#define OPT_STUDY               7
#define OPT_UCI_LIMIT_STRENGTH  8
#define OPT_UCI_ELO             9
#define OPT_UCI_ELO_DELAY      10
#define OPT_PONDER             11
#define OPT_MULTI_PV           12
#define OPT_REP_FIX            13
#define OPT_MOVE_OVERHEAD      14
#define OPT_MIN_THINK_TIME     15
#define OPT_SLOW_MOVER         16
